...
def MyencryptMAC(message, EncKey, HMACKey):
    ...
    h.update(C) # Creates tag

    tag = h.finalize() # Returns the tag to be stored in variable, closes HMAC
...
def mainMACDesktop():
    ...
    # DESKTOP
    file = open("C:/Users/corni/Desktop/pandaDecrpyted.jpg","wb") # wb for writing in binary mode
...
def mainNoMAC():
    ...
    # DESKTOP
    file = open("C:/Users/corni/Desktop/pandaDecrypted.jpg","wb") # wb for writing in binary mode
